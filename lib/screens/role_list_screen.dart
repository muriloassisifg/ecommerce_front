...
import 'package:ecommerce_front/screens/add_role_popup.dart';
import 'package:ecommerce_front/widgets/role_card.dart';
        ...
        Consumer<RoleController>(
          builder: (context, controller, child) {
            ...
            return ListView.builder(
              itemCount:
                  controller.roles.length, // Número de categorias na lista
              itemBuilder: (context, index) {
                return RoleCard(
                    role: controller
                        .roles[index]); // Exibe cada categoria usando RoleCard
              },
            );
          },
        ),
            ...
            onPressed: () {
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AddRolePopup(); // Widget responsável por adicionar novas categorias
                },
              );
            },
